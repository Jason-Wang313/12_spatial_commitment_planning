...
\begin{table}[t]
  ...
  \resizebox{\linewidth}{!}{\input{../results/full_scale/table_main_scaling_10.tex}}
\end{table}
...
\begin{table}[t]
  ...
  \label{tab:topology}
  \resizebox{\linewidth}{!}{\input{../results/full_scale/table_topology_variants.tex}}
\end{table}
...
\begin{table}[t]
  ...
  \resizebox{\linewidth}{!}{\input{../results/full_scale/table_certificate_stress.tex}}
\end{table}
...
\begin{table}[t]
  ...
  \label{tab:recovery}
  \resizebox{\linewidth}{!}{\input{../results/full_scale/table_recovery_stress.tex}}
\end{table}
...
\begin{table}[t]
  ...
  \label{tab:geometry}
  \resizebox{\linewidth}{!}{\input{../results/full_scale/table_geometry_proxy.tex}}
\end{table}
